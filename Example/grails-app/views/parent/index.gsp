		...
		<div id="list-parent" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="firstname1" title="${message(code: 'parent.firstname1.label', default: 'Firstname1')}" />
					
						<g:sortableColumn property="lastname1" title="${message(code: 'parent.lastname1.label', default: 'Lastname1')}" />
