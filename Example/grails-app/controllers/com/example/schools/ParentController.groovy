...
class ParentController {
    ...
    def save(Parent parentInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'parentInstance.label', default: 'Parent'), parentInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'parentInstance.label', default: 'Parent'), params.id])
                redirect action: "index", method: "GET"
            }
